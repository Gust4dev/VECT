...
export const Profile: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-8 pb-16 min-h-[calc(100vh-8rem)] animate-fade-in-up">
      ...
      <div className="glass-panel rounded-3xl p-8 mb-8 relative overflow-hidden">
        ...
        <div className="relative mt-12 flex flex-col md:flex-row items-end md:items-center gap-6">
            ...
            <div className="flex-1 mb-2">
                <h1 className="text-3xl font-bold text-white mb-1">João Silva</h1>
                <p className="text-zinc-400">Arquiteto Senior • joao@archsynth.com</p>
            </div>
      ...
      <div className="mt-8">
          <button className="w-full p-4 glass-panel rounded-2xl text-red-400 hover:text-red-300 hover:bg-red-500/10 border-red-500/20 transition-all flex items-center justify-center gap-2 font-medium">
              <LogOut size={18} />
              Sair da Conta
          </button>
      </div>
